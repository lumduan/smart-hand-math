...
const en = {
  ...
  lessons: {
    ...
    listen: '🎧 Listen…',
    locked: '🔒 Locked',
    unlockTitle: '🔓 Unlock this lesson?',
    unlockBody: 'This lesson is still locked. Unlock it and try it anyway?',
    unlockConfirm: '🔓 Unlock',
    unlockCancel: 'Not yet',
    complete: '✅ Done',
...
const th: Strings = {
  ...
  lessons: {
    ...
    listen: '🎧 กำลังฟัง…',
    locked: '🔒 ล็อกอยู่',
    unlockTitle: '🔓 ปลดล็อกบทเรียนนี้ไหม?',
    unlockBody: 'บทเรียนนี้ยังล็อกอยู่ ปลดล็อกแล้วลองเล่นเลยไหม?',
    unlockConfirm: '🔓 ปลดล็อก',
    unlockCancel: 'ยังก่อน',
    complete: '✅ เสร็จแล้ว',
